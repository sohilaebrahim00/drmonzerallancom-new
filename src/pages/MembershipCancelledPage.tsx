...
export default function MembershipCancelledPage() {
  const waHref = whatsappLink(
    "Hello, I started joining a Monzer Allan membership but had a question before completing payment.",
  );
    ...
    <div className="mx-auto flex min-h-[60vh] w-full max-w-xl flex-col items-center justify-center px-6 py-24 text-center sm:px-10">
      ...
      <Reveal direction="up">
        ...
        <p className="mt-3 max-w-md text-sm leading-relaxed text-muted-foreground">
          No payment was made and nothing was charged. You can pick up where you left off anytime.
        </p>
