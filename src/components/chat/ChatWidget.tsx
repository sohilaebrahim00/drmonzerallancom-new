...
export function ChatWidget() {
  ...
  const launcher = (
    ...
    >
      ...
      <span
        className="absolute end-0.5 top-0.5 h-3 w-3 rounded-full bg-green ring-2 ring-navy"
        aria-hidden="true"
      />
    </motion.button>
  );
