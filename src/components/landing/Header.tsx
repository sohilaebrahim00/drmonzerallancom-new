  ...
  return (
    <header className="animate-fade-in relative z-20 mx-auto flex w-full max-w-7xl items-center justify-between gap-4 px-6 py-6 sm:px-10 sm:py-7">
      ...
      <a
        ...
        className="group inline-flex items-center gap-2 rounded-full border border-border bg-card/50 px-4 py-2 text-sm font-semibold text-navy/80 backdrop-blur-sm transition-all duration-300 hover:border-turquoise hover:bg-card hover:text-turquoise"
      >
